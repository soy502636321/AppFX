...
public class SmsSender {
	...
	public int connect() {
		...
		switch(i) {
			case 0: 
				BeanFactory.debug(getCommon() + "初始化成功");
				break;
			case -1:
